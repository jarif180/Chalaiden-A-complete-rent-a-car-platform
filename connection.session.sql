...
delete from driver where businessID = 2;

SELECT * FROM company;

DELETE FROM company WHERE businessID = 2;
...
SELECT driver.username, driver.lisenceNo, driver.rating, company.username AS company_username 
                 FROM driver 
                 RIGHT JOIN company ON driver.businessID = company.businessID
